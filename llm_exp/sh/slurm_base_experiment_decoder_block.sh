#! /usr/bin/env bash
#SBATCH --job-name=midsteer_base_experiment-decoder_block
#SBATCH --partition=h100-camera-train
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=slurm_base_experiment-decoder_block-%j.out
#SBATCH --error=slurm_base_experiment-decoder_block-%j.err
